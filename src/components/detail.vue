...
<script>
  ...
  import stocksCharts from "./pages/stocksCharts";
  import '../js/public';
...
//            e_time;
//
//          switch(this.option.lineType){
//            case "minute":
//              e_time = e_date + " " + e_day + " " + formatTime((object.Time/100000>=1)?object.Time:("0"+object.Time));
//              k_categoryData.push(e_time);
//              break;
//            case "day":
//              this.HistoryData.hTime = formatTime((object.Time/100000>=1)?object.Time:("0"+object.Time));
...
//          if(k_categoryData[0].toString() == this.HistoryData.hCategoryList[this.HistoryData.hCategoryList.length-1]){
//            lastClose = this.HistoryData.hValuesList[this.HistoryData.hValuesList.length-2][1];
//          }
//
//          let e_open = (object.Open),          // 开
//            e_highest = (object.High),       // 高
//            e_lowest = (object.Low),         // 低
//            e_price = (this.option.lineType=="day"&&(!isHistory))?(object.Last):(object.Price),           // 收盘价
...
//          }else{
//            e_volume = (e_price-e_open)>=0?[this.HistoryData.hVolumesList.length,e_volumnData,-1]:[this.HistoryData.hVolumesList.length,e_volumnData,1];
//          }
//
//          lastClose = e_price;
//
...
//        if(isHistory){
//          this.HistoryData.hDate = data.date;
//          this.HistoryData.hDay = data.day;
//          this.HistoryData.hCategoryList = data.categoryData;
//          this.HistoryData.hValuesList = data.values;
//          this.HistoryData.hValuesPercentList = data.valuesPercent;
//          this.HistoryData.hVolumesList = data.volumes;
//          this.HistoryData.hZValuesList = data.zValues;
//          this.HistoryData.hZValuesListPercent = data.zValuePercent;
//          this.HistoryData.hZf = data.amplitude;
//          this.HistoryData.hZfList = data.amplPercent;
//        }else{
...
//          var lastTime = this.HistoryData.hCategoryList[this.HistoryData.hCategoryList.length-1];
//
...
//
//            this.HistoryData.hValuesList[this.HistoryData.hValuesList.length-1] = n_values;
//            this.HistoryData.hVolumesList[this.HistoryData.hVolumesList.length-1] = n_volumes;
//            this.HistoryData.hZValuesList[this.HistoryData.hZValuesList.length-1] = n_zValues;
//            this.HistoryData.hZValuesListPercent[this.HistoryData.hZValuesListPercent.length-1] = n_zValuePercent;
//            this.HistoryData.hValuesPercentList[this.HistoryData.hValuesPercentList.length-1] = n_valuesPercent;
//            this.HistoryData.hZf[this.HistoryData.hZf.length-1] = n_zf;
//            this.HistoryData.hZfList[this.HistoryData.hZfList.length-1] = n_zfList;
//          }else{
//            this.HistoryData.hDate.push(n_date);
//            this.HistoryData.hDay.push(n_day);
//            this.HistoryData.hCategoryList.push(n_category);
//            this.HistoryData.hValuesList.push(n_values);
//            this.HistoryData.hVolumesList.push(n_volumes);
//            this.HistoryData.hZValuesList.push(n_zValues);
//            this.HistoryData.hZValuesListPercent.push(n_zValuePercent);
//            this.HistoryData.hValuesPercentList.push(n_valuesPercent);
//            this.HistoryData.hZf.push(n_zf);
//            this.HistoryData.hZfList.push(n_zfList);
//          };
//        }
//      },
...
//                  return this.HistoryData.hCategoryList[valueStr];
//                },
//                showDetail: true
//              },
//            ],
...
//              {
//                type: 'category',
//                data: this.HistoryData.hCategoryList,
//                scale: true,
//                boundaryGap: true,
//                axisTick:{ show:false },
//                axisLine: { show:false },
...
//                    if(this.option.lineType=="minute"){
...
//                  }
//                },
//                data: this.HistoryData.hValuesList,
//                markPoint: {
//                  symbolSize: 20,
//                  data: [
//                    {
...
//                xAxisIndex: 1,
//                yAxisIndex: 1,
//                data: this.HistoryData.hVolumesList,
//                itemStyle: {
//                  normal: {
//                    color: '#e22f2a',
//                    color0: '#3bc25b'
